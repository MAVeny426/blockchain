//Create a smart contract to store an employee record which includes, name, department, designation, salary. 
//Write unnecessary functions to set employee details, read employee details, pay the employee.
